 ...
 * @author Shai Almog
 */
public class MyPushTestStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MyPushTest";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MyPushTestStub());
    }
